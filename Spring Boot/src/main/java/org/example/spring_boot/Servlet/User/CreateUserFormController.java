...
public class CreateUserFormController {
    ...
    public CreateUserFormController(UtilisateurRepository utilisateurDAO, ClasseRepository classeDAO) {
    ...
    public String showUserForm(
        ...
        if ("etudiant".equalsIgnoreCase(type)) {
            ...
            return "Admin/createEnseignant"; // Correspond à /WEB-INF/jsp/Admin/createEnseignant.jsp
        } else {
    ...
    public String createUser(
        ...
        if (!errors.isEmpty()) {
            ...
            model.addAttribute("classes", classes);
            return "Admin/createEtudiant"; // Retourne au formulaire avec les erreurs
        }
